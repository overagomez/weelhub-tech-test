...
export class CreateUserUseCase {
    ...
    async execute(id, name, surname, email, phoneNumberPrefix, phoneNumberSuffix, identityDocumentNumber, identityDocumentType) {
        ...
        const user = User.create(new Id(id), new Name(name), new Surname(surname), new Email(email), new PhoneNumber(new PhoneNumberPrefix(phoneNumberPrefix), new PhoneNumberSuffix(phoneNumberSuffix)), new IdentityDocument(new IdentityDocNumber(identityDocumentNumber), new IdentityDocType(identityDocumentType)));
